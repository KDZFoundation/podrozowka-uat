...
const fetchPostcards = async (userId: string): Promise<InventoryCard[]> => {
  // A postcard becomes part of the traveller's collection only after its
  // order has been paid.  POD units are generated by the payment trigger;
  // this extra filter also protects the UI from any legacy/test inventory
  // unit that was assigned before payment.
